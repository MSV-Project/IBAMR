...
if(NOT DEFINED HDF5_DIR)
  ...
  set(Hdf5_source ${IBAMR_BINARY_DIR}/SuperBuild/${proj})

  configure_file(${IBAMRSuperBuild_CMAKE_SOURCE_DIR}/hdf5_patch_step.cmake.in
    ${CMAKE_CURRENT_BINARY_DIR}/SuperBuild/hdf5_patch_step.cmake
    @ONLY)

  set(Hdf5_PATCH_COMMAND ${CMAKE_COMMAND} -P ${CMAKE_CURRENT_BINARY_DIR}/SuperBuild/hdf5_patch_step.cmake)
...
list(APPEND IBAMR_SUPERBUILD_EP_ARGS -DHDF5_DIR:PATH=${ep_install_dir}/share/cmake/hdf5)
list(APPEND IBAMR_SUPERBUILD_EP_ARGS -DHDF5_INCLUDE_PATH:PATH=${ep_install_dir}/include)
