...
c
     ...
     &          ifirst2-nugc2:ilast2+nugc2,0:depth-1)
...
c
      ...
      double precision X_cell(0:3-1),w0(0:2),w1(0:2),w2(0:2)
c
...
c
      ...
      integer patch_touches_lower_physical_bdry(0:3-1)
      integer patch_touches_upper_physical_bdry(0:3-1)
...
c
      ...
      double precision w0(0:3),w1(0:3),w2(0:3),f(0:3)
      double precision w(0:3,0:3,0:3),wyz,wz

      LOGICAL account_for_phys_bdry
      LOGICAL touches_lower_bdry(0:3-1)
      LOGICAL touches_upper_bdry(0:3-1)
c
...
c
      ...
      double precision X_cell(0:3-1),f(0:3),w0(0:3),w1(0:3),w2(0:3)
...
c
      ...
      double precision X_cell(0:3-1),f(0:5),w0(0:5),w1(0:5),w2(0:5)
